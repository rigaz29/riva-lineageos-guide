...
- **[SukiSU-Ultra + susfs (opsional)](./SUKISU-ULTRA-Redmi5A.md)** — root berbasis kernel dengan penyembunyian susfs. Kernel Mi-Thorium sudah punya titik hook bawaan yang cocok dengan branch `builtin` SukiSU, jadi **tidak perlu mengedit source kernel**.
